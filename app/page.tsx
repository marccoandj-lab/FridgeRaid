            ...
            {dailyMeals.map((meal, i) => (
              <Link key={meal.idMeal} href={`/recipe/${meal.idMeal}`}>
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-xl bg-card ring-1 ring-foreground/5 transition-all duration-500 hover:-translate-y-1 hover:shadow-lg hover:shadow-amber-500/5 hover:ring-amber-500/20 active:scale-[0.98]"
                >
        ...
        >
          ...
          {seasonal.slice(0, 8).map((item) => (
            <button
              ...
              className="rounded-full bg-card px-3 py-1.5 text-xs text-muted-foreground ring-1 ring-foreground/10 transition-all hover:border-amber-500/30 hover:text-foreground active:scale-[0.96]"
            >
              {item}
            </button>
          ))}
        ...
        >
          ...
          {searches.map((s) => (
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-full border border-amber-500/15 bg-card px-3 py-1.5 text-xs text-muted-foreground transition-all hover:border-amber-500/30 hover:text-foreground active:scale-[0.96]"
            >
              {s.name}
              <span
                onClick={(e) => {
