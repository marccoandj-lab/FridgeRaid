                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center gap-3 rounded-xl p-3 text-left transition-all active:scale-[0.98] ${
                        entry ? 'bg-amber-500/10 ring-1 ring-amber-500/20' : 'bg-card ring-1 ring-foreground/5'
                      }`}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        {entry ? (
                          <div className="flex items-center justify-between gap-2">
                            <Link href={`/recipe/${entry.recipeId}`} className="text-sm font-medium text-foreground hover:text-amber-300 line-clamp-1" onClick={(e) => e.stopPropagation()}>
                              {entry.recipeName}
                            </Link>
                            <button
